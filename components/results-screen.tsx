...
export function ResultsScreen() {
  ...
  return (
    <motion.div
      ref={containerRef}
      className="min-h-screen bg-[#F5F3EE] py-12"
      ...
      <div className="max-w-[800px] mx-auto px-4 pt-10">
        ...
        <div className="grid md:grid-cols-[1fr_320px] gap-5">
              ...
              {strengthBars.map((bar, idx) => (
                <div key={idx}>
                  ...
                  <div className="flex justify-between items-baseline mb-2">
                    <span className="text-[14px] font-medium text-[#1B2D4F]">{bar.label}</span>
                    <span className="text-[14px] font-bold text-[#1B2D4F]">{bar.score}</span>
                  </div>
                  {/* Track and Fill */}
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <label className="text-xs uppercase font-semibold tracking-[0.12em]" style={{ color: 'rgba(255, 255, 255, 0.5)' }}>
                Eng mos kasblar
              </label>
                  ...
                  <div key={idx}>
                    <div className="flex items-start justify-between gap-2 mb-1">
                      <div className="flex-1">
                        <div className="text-[15px] font-bold text-white">{career.name}</div>
                    ...
                    {idx < careers.length - 1 && (
                      <div className="h-px mt-3" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)' }} />
                    )}
                  </div>
                ))}
              </div>
            ...
            >
              ...
              <div className="flex flex-col" style={{ gap: '12px', marginTop: '12px' }}>
                <Link
                  href="/articles"
              ...
              {/* Share row */}
              <div className="flex items-center" style={{ marginTop: '16px', gap: '12px' }}>
